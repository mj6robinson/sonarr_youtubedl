...
class SonarrYTDL(object):
        ...
        for ser in series[:]:
            ...
            for wnt in self.series:
                if wnt['title'] == ser['title']:
                    ...
                    if 'title_check' in wnt:
                        ser['title_check'] = wnt['title_check']
                    if 'proxy' in wnt:
                        ser['proxy'] = wnt['proxy']
                    if 'subtitles' in wnt:
                        ser['subtitles'] = True
    ...
    def ytdl_eps_search_opts(self, regextitle, playlistreverse, cookies=None, proxy=''):
        ytdlopts = {
            'ignoreerrors': True,
    ...
    def ytsearch(self, ydl_opts, playlist, title_check):
        try:
